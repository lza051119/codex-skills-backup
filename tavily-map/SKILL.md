---
name: tavily-map
description: "Discover and map URLs on a website via the Tavily CLI. Use when the user needs a sitemap-like list, URL discovery, or to find relevant pages before extraction or crawling."
---
