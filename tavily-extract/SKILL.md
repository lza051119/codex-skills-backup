---
name: tavily-extract
description: "Extract clean readable content from one or more URLs via the Tavily CLI. Use when the user provides URLs and needs page text, metadata, or structured extraction rather than browser interaction."
---
