...
Fetch a page and return its content, headers, and metadata 鈥?no browser session required.
...
1. **Start with Fetch** for simple page retrieval 鈥?it's faster and cheaper than a browser session
