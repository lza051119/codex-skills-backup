---
name: tavily-search
description: "Search the web with LLM-optimized results via the Tavily CLI. Use for current information, news, source discovery, article finding, domain-filtered search, or general web lookup when Tavily is preferred."
---
