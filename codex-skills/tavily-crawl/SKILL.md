---
name: tavily-crawl
description: "Crawl websites or documentation with the Tavily CLI. Use when the user needs multiple pages from a site, docs corpus collection, or broad content extraction from a domain."
---
