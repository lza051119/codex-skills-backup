...
Search the web and return structured results 鈥?no browser session required.
...
2. **Use specific queries** for better results 鈥?include keywords, site names, or topics
