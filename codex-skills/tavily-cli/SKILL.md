---
name: tavily-cli
description: "Web search, content extraction, crawling, URL discovery, and deep research via the Tavily CLI. Use when the user asks to search the web, extract a webpage, crawl documentation, map a site, or conduct research with citations using Tavily."
